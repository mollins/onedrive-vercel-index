...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'dev@moltql.onmicrosoft.com',
  ...
  email: 'mailto:3217686189@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/mollins',
    },
    {
      name: 'Blog',
      link: 'https://mollins.github.io',
    },
  ],
